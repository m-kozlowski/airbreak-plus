...
EVENT_FAMILIES: dict[str, tuple[str, ...]] = {
    ...
    "alarmEvents": (
        ...
        "AlarmModuleCommunicationError", "SystemErrorMotorStallHW",
        ...
        "SystemErrorMotorSticky", "SystemErrorMotorFETs",
        "SystemErrorMotorESD", "SystemErrorMotorHwMitigationIC",
        "SystemErrorNoFlowData", "SystemErrorSettingsReset",
        "SystemErrorCalibrationReset", "SystemErrorPressureStuckHigh",
        "SystemErrorPressureStuckLow", "SystemErrorPressureStuckMid",
        "SystemErrorFlowSensorStuckLow", "SystemErrorFlowSensorStuckHigh",
        "SystemErrorPressureSensorDrift",
        "SystemErrorPressureSensorsPlausibility",
        "SystemErrorImplausibleSupplyVoltage",
        "SystemErrorFaultyHWFaultDetectionCircuitry",
        "SelfTestInitiated", "IndicatorSelfTestPass",
        "SupercapacitorSelfTestPass", "IndicatorSelfTestFail",
        "SupercapacitorSelfTestFail", "AlarmMute",
        "AlarmUpgradeInitiated", "AlarmUpgradeSuccessful",
        "AlarmUpgradeFailed",
    ),
    "alarmDiagnosticEvents": (
    ...
    "SystemActivityEvents-FrequentActivityEvents": (
        "NoActivity", "PressureStart", "PressureStop",
    ...
    "SystemActivityEvents-SporadicActivityEvents": (
        "NoActivity", "DataResetStarted", "CalibrationStarted",
        "SystemErrorStarted",
    ...
    "SystemExceptionEvents-SystemErrors": (
        ...
        "FaultyHWFaultDetectionCircuitry", "AlarmModuleComms",
    ),
    "SystemExceptionEvents-RecoverableErrors": (
        "NoError", "HoseDisconnected", "HumidifierTubRemoved",
        "HoseBlocked",
    ),
    "SystemExceptionEvents-HumidifierErrors": (
    ...
    "SystemExceptionEvents-HeatedTubeErrors": (
        ...
        "ControlFETShortCircuit", "HeatingOpenCircuit", "SensorFail",
        "OverCurrent", "HeatingNTCOpenCircuit",
    ),
    "DiagnosticExceptionEvents-AppErrors": (),
    "DiagnosticExceptionEvents-FatalErrors": (),
    "DiagnosticExceptionEvents-ResettableErrors": (),
